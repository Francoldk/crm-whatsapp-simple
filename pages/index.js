...
const styles = {
  ...
  convItem: { display: 'flex', gap: '12px', padding: '14px', cursor: 'pointer', borderBottom: '1px solid rgba(51,65,85,0.25)', transition: 'background 0.15s' },
  convActions: { position: 'absolute', top: '10px', right: '10px', display: 'flex', gap: '4px', zIndex: 2 },
