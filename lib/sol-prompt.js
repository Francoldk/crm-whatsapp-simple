...
FORMATO DE COTIZACIÓN INDIVIDUAL (Texto para enviar al cliente por WhatsApp):
━━━━━━━━━━━━━━━
...
Aunque en el texto para el cliente (replyMessage) muestres la suma de los impuestos de importación en un solo número unificado, en el objeto JSON ("extractedData") ESTÁS OBLIGADA a calcular el desglose y completarlo por separado, guardando los Derechos de Importación en "dutiesUSD" y el resto de tasas y percepciones sumadas en "taxesUSD". Esto es vital para el CRM.
